...
var config = {
  apiOrigins: {
    ...
    production: 'https://networkingapp.herokuapp.com/'
  }
};
...
var onGetPeople = function onGetPeople(event) {
  ui.clearPeople();
  event.preventDefault();
  api.getPeople().then(ui.getPeopleSuccess).catch(ui.failure);
};

var onClearPeople = function onClearPeople(event) {
  event.preventDefault();
  ui.clearPeople();
};
...
var initialLogIn = function initialLogIn(event) {
  event.preventDefault();
  api.getPeople().then(ui.getPeopleSuccess).catch(ui.failure);
};
...
var showPeopleTemplate = __webpack_require__(16);
...
var createNoteSuccess = function createNoteSuccess() {
  // console.log('Signed out successfully')
  // $('.headers').hide()
...
var createNoteFailure = function createNoteFailure() {
  // console.error(error)
  $('#message').text('Note Send Failure');
};

var updateNoteSuccess = function updateNoteSuccess() {
  // console.log('Signed out successfully')
  // $('.headers').hide()
  document.getElementById('getPeopleButton').click();
...
var updateNoteFailure = function updateNoteFailure() {
  // console.error(error)
  $('#message').text('Note Update Failure');
};

var deleteNoteSuccess = function deleteNoteSuccess() {
  // console.log('Signed out successfully')
  // $('.headers').hide()
  document.getElementById('getPeopleButton').click();
...
var deleteNoteFailure = function deleteNoteFailure() {
  // console.error(error)
  $('#message').text('Note Delete Failure');
};

var getPeopleSuccess = function getPeopleSuccess(data) {
  // console.log(data)
  var showPeopleHtml = showPeopleTemplate({ people: data.people });
...
var initialLogIn = function initialLogIn(data) {
  api.getPeople();
  // console.log(data.people.length)
  // if (showPeopleHtml.length === 0) {
  //   $('#editNote').hide()
...
var clearPeople = function clearPeople() {
  $('.content').empty();
...
module.exports = {
  ...
  getPeopleSuccess: getPeopleSuccess,
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n   <ul data-id=\""
    ...
    + "</small></li>\n     <li> <small>Connections: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.connections : stack1), depth0))
    + "</small></li>\n     <li> <small>Partner: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.partner : stack1), depth0))
    + "</small></li>\n     <li> <small>Children: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.children : stack1), depth0))
    + "</small></li>\n     <li> <small>Notes: "
  ...
  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.people : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
